...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // Mock login logic - will be implemented later
    setTimeout(() => {
      setIsLoading(false);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-zinc-900 dark:via-zinc-900 dark:to-black px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-600 dark:text-zinc-400">
            Умная аналитика ваших финансов
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 shadow-xl shadow-zinc-200/50 dark:shadow-none border border-zinc-100 dark:border-zinc-800">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">Вход</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-zinc-600 dark:text-zinc-400">Запомнить меня</span>
              </label>
              <a href="#" className="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">
                Забыли пароль?
              </a>
            </div>
          ...
          {/* Social Login */}
          <button className="w-full py-3 px-4 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-medium hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors flex items-center justify-center gap-3">
